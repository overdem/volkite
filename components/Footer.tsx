        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 'clamp(32px,5vw,60px)', marginBottom: '48px' }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: '14px', marginTop: '20px' }}>
              ...
              <a href="https://wa.me/905326101011" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" style={{ color: '#9fc0cf', textDecoration: 'none' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <a href="tel:+905326101011" style={{ color: '#9fc0cf', textDecoration: 'none', fontSize: '15px' }}>+90 532 610 10 11</a>
              <a href="mailto:info@volkite.com" style={{ color: '#9fc0cf', textDecoration: 'none', fontSize: '15px' }}>info@volkite.com</a>
              <p style={{ color: '#9fc0cf', fontSize: '14px', lineHeight: 1.5, margin: 0 }}>Kefaloz Koyu<br />Gökçeada, Çanakkale</p>
            </div>
          </div>
        </div>
