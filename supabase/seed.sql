...
('beginner', 1,
  ...
  '[{"label":"Özel ders","price":"700€"},{"label":"2 kişilik grup / kişi","price":"600€"},{"label":"Ek ders (1 saat)","price":"80€"}]',
  '[{"label":"Private","price":"€700"},{"label":"Group of 2 / person","price":"€600"},{"label":"Extra hour","price":"€80"}]',
  '[{"label":"Частен","price":"700€"},{"label":"Група от 2 / човек","price":"600€"},{"label":"Доп. час","price":"80€"}]',
  '[{"label":"Privat","price":"700€"},{"label":"Grup de 2 / pers.","price":"600€"},{"label":"Oră extra","price":"80€"}]',
...
('discovery', 2,
  ...
  '[{"label":"Fiyat için bize sorun","price":""}]',
  '[{"label":"Contact us for pricing","price":""}]',
  '[{"label":"Свържете се за цена","price":""}]',
  '[{"label":"Contactați-ne pentru preț","price":""}]',
  'Rezervasyon', 'Book', 'Резервация', 'Rezervare'),
...
values (1,
  '+90 533 241 10 15',
  'info@volkite.com',
  'Eşelek Köyü, Köy Sokağı 104/1, Gökçeada-Çanakkale',
  'Eşelek Village, Köy Sokağı 104/1, Gökçeada, Çanakkale, Turkey',
  'https://www.instagram.com/volkite/',
  'https://www.facebook.com/volkite',
  'https://wa.me/905332411015',
  'https://kiting.live',
  'Nisan–Kasım',
  'April–November',
  300,
