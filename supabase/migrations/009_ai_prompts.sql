...
-- NOT: Canlı kaynak bu tablo. Repo'daki seed + kod SYSTEM_STATIC + doc §1
-- yalnızca fallback/referans olup canlı içerikle (v4) eşitlenmiştir.
...
-- Seed: web-agent system prompt (canlı v4 ile eşit)
